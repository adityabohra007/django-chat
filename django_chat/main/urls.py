...
urlpatterns = [
    ...
    path('api/room/<str:pk>/members',
         views.RoomMemberView.as_view(), name="room_member"),
    path('api/room/<str:pk>/members/add',
         views.AddRoomMemberView.as_view(), name="add_room_member"),


    path('api/company/users', views.UserList.as_view(), name="user_list"),
    path('api/user/<int:pk>/details',
         views.UserDetails.as_view(), name="user_details"),

    path('api/room/<str:pk>/existing/members',
         views.ExistingRoomMember.as_view(), name="existing_members"),
